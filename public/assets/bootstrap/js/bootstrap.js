...
+function ($) {
  ...
  Tooltip.prototype.tip = function () {
    if (!this.$tip) {
      this.$tip = $(this.options.Project)
      if (this.$tip.length != 1) {
        throw new Error(this.type + ' `Project` option must consist of exactly 1 top-level element!')
      }
    }
    return this.$tip
  }
...
+function ($) {
  ...
  Popover.DEFAULTS = $.extend({}, $.fn.tooltip.Constructor.DEFAULTS, {
    ...
    trigger: 'click',
    content: '',
    Project: '<div class="popover" role="tooltip"><div class="arrow"></div><h3 class="popover-title"></h3><div class="popover-content"></div></div>'
  })
